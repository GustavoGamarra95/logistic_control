...
export const useInventario = (params?: QueryParams) => {
  ...
  return {
    ...
    isLoading,
    error,
    createInventario: createMutation.mutateAsync,
    updateInventario: updateMutation.mutateAsync,
    deleteInventario: deleteMutation.mutate,
    registrarEntrada: registrarEntradaMutation.mutate,
    registrarSalida: registrarSalidaMutation.mutateAsync,
    reservar: reservarMutation.mutateAsync,
    liberarReserva: liberarReservaMutation.mutateAsync,
